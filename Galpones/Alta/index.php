...
<?php
    ...
    $sentencia = $bd -> query("select * from altasgalpon");
    $altasgalpon = $sentencia->fetchAll(PDO::FETCH_OBJ);
    //print_r($persona);
?>
                ...
                <div class="p-4">
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <?php 
                                foreach($altasgalpon as $dato){ 
                            ?>

                            <tr>
                                <td scope="row"><?php echo $dato->codigo; ?></td>
                                <td><?php echo $dato->Altas; ?></td>
            ...
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrar.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="txtAlta" autofocus required>
                    </div>
                    <div class="mb-3">
